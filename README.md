...
- [Monads etc.](http://ocamllabs.io/iocamljs/monads.html) - Interactive examples of Monad implementations in OCaml
- [Category Theory for Programmers](https://bartoszmilewski.com/2014/10/28/category-theory-for-programmers-the-preface/)

## Code Examples
- [Material for the Introduction to Functional Game Programming with Scala workshop](https://github.com/jdegoes/lambdaconf-2014-introgame)
